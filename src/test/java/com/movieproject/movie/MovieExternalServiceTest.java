...
class MovieExternalServiceTest {
    ...
    void createMovie_success() {
        ...
        ReflectionTestUtils.setField(testDirector, "directorId", 1L);
        ...
        when(movieInternalService.createMovie(requestDto, testDirector)).thenReturn(mockMovie);

        // when
        MovieResponseDto responseDto = movieExternalService.createMovie(requestDto);
        ...
        verify(movieInternalService, times(1)).createMovie(requestDto, testDirector);
    }
}